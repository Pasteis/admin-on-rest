...
describe('loading reducer', () => {
    ...
    it('should increase with fetch or auth actions', () => {
        ...
        assert.equal(1, reducer(0, { type: USER_REGISTER_LOADING }));
    });
    it('should decrease with fetch or auth actions success or failure', () => {
        ...
        assert.equal(0, reducer(1, { type: USER_REGISTER_SUCCESS }));
        assert.equal(0, reducer(1, { type: USER_REGISTER_FAILURE }));
    });
});
