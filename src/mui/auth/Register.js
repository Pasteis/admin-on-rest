...
import { userRegister as userRegisterAction } from '../../actions/authActions';
...
class Register extends Component {
    ...
    register = (auth) => this.props.userRegister(auth, this.props.location.state ? this.props.location.state.nextPathname : '/');
...
const enhance = compose(
    ...
    connect(mapStateToProps, { userRegister: userRegisterAction }),
);
